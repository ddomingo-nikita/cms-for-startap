...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    eventType: Schema.Attribute.Enumeration<
      ['Conference', 'Briefing', 'Concert', 'Show']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiTicketTicket extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    refundPolicy: Schema.Attribute.Blocks;
    seat: Schema.Attribute.String;
    ticketStatus: Schema.Attribute.Enumeration<['paid', 'unpaid']>;
    ticketType: Schema.Attribute.Enumeration<['regular', 'vip', 'special']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    zone: Schema.Attribute.Enumeration<
